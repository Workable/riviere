...
const mapInReq = ({ ctx, health, bodyKeys, headersRegex }) => {
  ...
  const meta = extractRequestMeta(ctx, bodyKeys, headersRegex);
...
const mapOutRes = ({ ctx, health, bodyKeys, headersRegex }) => {
  ...
  const meta = extractRequestMeta(ctx, bodyKeys, headersRegex, 'request');
...
function extractRequestMeta(ctx, bodyKeys, headersRegex, prefix = '') {
