...
const serializeTokeyValue = require('./serializers/serializeToKeyValue');
...
class Loggable extends EventEmitter {
  constructor({ adapter, logger, bodyKeys, getLogCtx, headersRegex, health, serialize = serializeTokeyValue }) {
    super();
