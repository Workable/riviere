...
class BaseFormatter {
  ...
  getOutRequestPrefix(obj) {
    ...
    return `${requestInfo} ${outReq.MSG} ${method} ${obj.href} ${obj.contentLength}b`;
  }
  ...
  getInResponsePrefix(obj) {
    ...
    return `${requestInfo} ${inRes.MSG} ${method} ${obj.href} ${status} ${obj.duration}ms ${obj.contentLength}b`;
  }
